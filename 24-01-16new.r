...
# New Model
model <- lm(mdev ~. -rad -tax, data=Boston)
summary(model)
...
qqnorm(lm.std, ylab="Standardized Residuals", xlab="Nornal Scores", main="Normal Probability Plot for Residuals")
qqline(lm.std)
